...
(function () {
  ...
  style.textContent = `
    ...
    .library-drawer .drawer-kicker{font:9px var(--mono);letter-spacing:.12em;color:var(--red);text-transform:uppercase}.library-drawer h2{font:italic 500 clamp(2.3rem,6vw,4rem) var(--serif);line-height:.9;letter-spacing:-.06em;margin:14px 0 24px}.library-drawer nav{display:grid;gap:0;border-top:1px solid var(--line)}.library-drawer nav a{padding:16px 0;border-bottom:1px solid var(--line);font:10px var(--mono);letter-spacing:.09em;text-transform:uppercase;display:flex;justify-content:space-between;transition:.2s}.library-drawer nav a:hover{color:var(--red);padding-left:7px}.library-drawer .drawer-community{color:var(--red)}.library-drawer .drawer-footer{margin-top:auto;border-top:1px solid var(--line);padding-top:17px;font:9px/1.6 var(--mono);color:var(--muted);text-transform:uppercase}
